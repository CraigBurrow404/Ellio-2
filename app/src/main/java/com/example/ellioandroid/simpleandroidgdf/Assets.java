package com.example.ellioandroid.simpleandroidgdf;
...
import com.example.ellioandroid.framework.animation.Animation;
import com.example.ellioandroid.framework.animation.Frame;

public class Assets {
    private static SoundPool soundPool;
    public static Bitmap welcome, block, cloud1, cloud2, duck, grass, jump,
            run1, run2, run3, run4, run5, scoreDown, score, startDown, start, spaceship1,
            zap, ground;
    public static Animation runAnim;
    public static int hitID, onJumpID;

    public static void load() {
        welcome = loadBitmap("welcome1.png", false);
        ...
        spaceship1 = loadBitmap("spaceship1.png", true);
        zap = loadBitmap("zap.png", true);
        ground = loadBitmap("ground.png", true);
